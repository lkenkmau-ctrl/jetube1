...
export function TrendingIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
      <path d="M19.8 10.7L12 2l-2.5 4.5L6.2 4.2 2.5 11.6 1 9.6 4.7 16h14.6l3.7-6.4-1.5 2z"/>
    </svg>
  )
}
...
export function SubscriptionsIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
      <path d="M18.7 4.5H5.3C3.5 4.5 2 5.9 2 7.7v8.6c0 1.8 1.5 3.2 3.3 3.2h13.4c1.8 0 3.3-1.4 3.3-3.2V7.7c0-1.8-1.5-3.2-3.3-3.2zM10 15.5V8.5l6 3.5-6 3.5z"/>
    </svg>
  )
}
...
export function ThumbDownIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
      <path d="M23 3H9.83l1.23-4.57.03-.32c0-.41-.17-.79-.44-1.06L9.17 0 2.59 6.59C2.22 6.95 2 7.45 2 8v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73V5c0-1.1-.9-2-2-2z"/>
    </svg>
  )
}
